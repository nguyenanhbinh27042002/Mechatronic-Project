...
cv2.createTrackbar("Red Max","TrackBars",15,255,empty)

cv2.createTrackbar("Green Min","TrackBars",0,255,empty)
cv2.createTrackbar("Green Max","TrackBars",150,255,empty)

cv2.createTrackbar("Blue Min","TrackBars",0,255,empty)
cv2.createTrackbar("Blue Max","TrackBars",15,255,empty)
...
while True:
    ...
    red_max = cv2.getTrackbarPos("Red Max","TrackBars")

    green_min = cv2.getTrackbarPos("Green Min","TrackBars")
    green_max = cv2.getTrackbarPos("Green Max","TrackBars")

    blue_min = cv2.getTrackbarPos("Blue Min","TrackBars")
    blue_max = cv2.getTrackbarPos("Blue Max","TrackBars")
    print(h_min,h_max,s_min,s_max,v_min,v_max)
    lower = np.array([h_min,s_min,v_min])
    upper = np.array([h_max,s_max,v_max])

    lower1 = np.array([red_min,green_min,blue_min])
    upper1 = np.array([red_max,green_max,blue_max])
