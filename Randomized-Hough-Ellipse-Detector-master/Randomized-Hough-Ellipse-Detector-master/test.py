...
path = "D:\\Randomized-Hough-Ellipse-Detector-master\\Randomized-Hough-Ellipse-Detector-master" #"D:\\1LAB"
original_image = cv2.imread(path + "\\Rhough.png", 0)
mask = cv2.imread(path + "\\Rhough.png", 0)
