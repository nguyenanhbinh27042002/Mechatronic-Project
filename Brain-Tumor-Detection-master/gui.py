...
class Gui:
    ...
    def check(self):
        ...
        if (self.val.get() == 1):
            ...
            if res > 0.5:
                resLabel = tkinter.Label(self.FirstFrame.getFrames(), text="Phat Hien Khoi U", height=1, width=20)
                resLabel.configure(background="White", font=("Comic Sans MS", 16, "bold"), fg="red")
            else:
                resLabel = tkinter.Label(self.FirstFrame.getFrames(), text="Khong Phat Hien Khoi U", height=1, width=20)
